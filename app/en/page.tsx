    ...
    <main lang="en">
      ...
      <header className="site-header">
        ...
        <nav>
          ...
          <details className="services-menu">
            ...
            <div>
              <a href="/vakantieverhuur-malaga/">Holiday rental management</a>
              <a href="/midterm-verhuur-malaga/">
                Seasonal and mid-term rentals
              </a>
              <a href="/langetermijnverhuur-malaga/">Long-term rentals</a>
              <a href="/vastgoedbeheer-malaga/">Property management</a>
              ...
              <a href="/verhuurlicentie-malaga/">Rental licence</a>
            </div>
          </details>
        ...
        <details className="mobile-menu">
          ...
          <div>
            ...
            <b>Services</b>
            <a href="/vakantieverhuur-malaga/">Holiday rental management</a>
            <a href="/midterm-verhuur-malaga/">Seasonal and mid-term rentals</a>
            <a href="/langetermijnverhuur-malaga/">Long-term rentals</a>
            <a href="/vastgoedbeheer-malaga/">Property management</a>
            <a href="/schoonmaak-onderhoud-malaga/">Cleaning & maintenance</a>
            <a href="/renovatie-inrichting-malaga/">Renovation & furnishing</a>
            <a href="/verhuurlicentie-malaga/">Rental licence</a>
            <b>Company</b>
            <a href="/werkwijze/">How we work</a>
            <a href="/over-ons/">About us</a>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-inner">
          ...
          <h1>Enjoy your second home in Málaga. We take care of the rest.</h1>
          <p>
      ...
      <section className="regions compact-regions" id="regios">
        <div className="section-head">
          ...
          <h2>Local knowledge across Málaga</h2>
          <p>
      ...
      <section className="contact" id="contact">
        <div>
          ...
          <h2>Get an informed rental forecast for Málaga</h2>
          <p>
...
export const metadata = { robots: { index: false, follow: true }, keywords: ["property management Málaga","holiday rental management Málaga","Airbnb management Málaga","key holding Málaga","home checks Málaga","second home management Málaga","villa management Málaga","apartment management Málaga"], title: "Property Management Málaga | Holiday Rental & Key Holding", description: "Local property management in Málaga for international owners: holiday rental management, Airbnb management, key holding, home checks, cleaning and maintenance.", alternates: { canonical: "/en/", languages: { "nl-NL": "/", en: "/en/", es: "/es/", "x-default": "/" } }, openGraph: { locale: "en_GB", url: "/en/", type: "website" as const } };
