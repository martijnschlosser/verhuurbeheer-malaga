...
const services = [
  {
    ...
    icon: BedDouble,
    text: "Complete vakantieverhuur voor appartementen en woningen in Málaga Centro, Málaga Este en omliggende wijken: presentatie, boekingen, prijzen, gastencontact en lokale uitvoering.",
  },
  {
  ...
  },
  {
    ...
    price: "Maatwerk",
    icon: ShieldCheck,
    text: "Woningcontroles, sleutelbeheer en praktische opvolging in Málaga, ook wanneer je zelf langere tijd niet aan de Costa del Sol bent.",
  },
  {
    ...
    icon: Sparkles,
    text: "Wisselschoonmaak, linnen, inspecties en coördinatie van onderhoud door lokale partners rond Málaga.",
  },
  {
...
const faqs = [
  [
    "Wat kost vakantieverhuurbeheer in Málaga?",
  ...
  [
    "In welke delen van Málaga zijn jullie actief?",
    "We ondersteunen eigenaren in Málaga Centro, Málaga Este, El Limonar, Pedregalejo, Huelin, Teatinos en Cerrado de Calderón. De mogelijkheden bekijken we altijd per woning.",
  ],
  [
    "Heb ik een verhuurlicentie nodig voor vakantieverhuur in Málaga?",
...
export default function Home() {
  ...
  const schema = {
    ...
    description:
      "Nederlandstalig fullservice verhuurbeheer, vakantieverhuurbeheer en vastgoedbeheer voor woningeigenaren in Málaga.",
    parentOrganization: {
      "@type": "Organization",
    ...
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-inner">
          ...
          <h1>Geniet van je tweede huis in Málaga, wij regelen de rest.</h1>
          <p>
      ...
      <section
        ...
        aria-label="Mediterrane woningen en sfeer in Málaga"
      >
        <figure className="showcase-wide">
          <img
            src="/vastgoed-aan-zee-malaga.webp"
            alt="Witte mediterrane woningen aan zee in Málaga"
            width="1200"
            height="800"
            loading="eager"
          />
        ...
        <figure className="showcase-pool">
          <img
            ...
            alt="Zwembad met palmen en mediterrane tuin bij een villa in Málaga"
            width="1800"
            height="1118"
            loading="lazy"
          />
        ...
        <figure className="showcase-garden">
          <img
            src="/urbanisatie-zwembad-malaga.webp"
            alt="Witte urbanisatie met groene tuin en zwembad in Málaga"
            width="1600"
            height="1067"
            loading="lazy"
          />
        ...
        <figure className="showcase-terrace">
          <img
            ...
            alt="Zonnig terras met zeezicht in Málaga"
            width="1600"
            height="1067"
            loading="lazy"
          />
      ...
      <section className="services" id="diensten">
        <div className="section-head">
          ...
          <h2>Alles voor je woning in Málaga</h2>
          <p>
      ...
      <aside className="license-note">
        ...
        <a href="/verhuurlicentie-malaga/">Lees over de verhuurlicentie →</a>
      </aside>
      ...
      <section className="owner-experience" aria-label="De beleving van professioneel woningbeheer">
        ...
        <figure className="owner-experience-main">
          <img
            src="/woning-malaga-zeezicht.webp"
            alt="Verzorgde woning in Málaga met uitzicht op zee"
            width="1200"
            height="800"
            loading="lazy"
          />
        ...
        <figure className="owner-experience-detail">
          <img
            src="/woning-interieur-malaga.webp"
            alt="Licht en verzorgd interieur van een woning in Málaga"
            width="1200"
            height="800"
            loading="lazy"
          />
      ...
      <section className="regions compact-regions" id="regios">
        <div className="section-head">
          ...
          <h2>Lokaal actief in Málaga Centro en Málaga Este</h2>
          <p>
            Van Málaga Centro en El Limonar tot Pedregalejo, Huelin, Teatinos
            en Málaga Este.
          </p>
        </div>
        <div className="area-list" aria-label="Werkgebieden rond Málaga">
          <b>Málaga Centro</b>
          <b>Málaga Este</b>
          <b>El Limonar</b>
          <b>Pedregalejo</b>
      ...
      <section className="faq">
        <div>
          ...
          <p>
            De belangrijkste vragen over onze diensten en tarieven in Málaga.
          </p>
        </div>
        <div>
          {homeFaqs.map(([q, a], i) => (
      ...
      <section className="home-owner-cta" id="woning-aanmelden">
        <div className="home-owner-cta-image" role="img" aria-label="Zonnig terras met uitzicht op zee in Málaga" />
        <div className="home-owner-cta-copy">
          <p className="kicker orange">Vrijblijvend kennismaken</p>
          <h2>Klaar om meer uit je woning in Málaga te halen?</h2>
          <p>
