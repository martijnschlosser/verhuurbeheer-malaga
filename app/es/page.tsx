...
const faqs = [
  ...
  [
    ...
    "Ayudamos a propietarios en Málaga Pueblo, Málaga Este, La Cala de Málaga, Pedregalejo, Huelin, Málaga Golf, Cerrado de Calderón y Miraflores. Cada vivienda y ubicación se valora individualmente.",
  ],
  [
    ...
    <main lang="es">
      ...
      <section className="home-team">
        <div className="home-team-copy">
          ...
          <h2>Contacto personal con profesionales que conocen Málaga.</h2>
          <p>
