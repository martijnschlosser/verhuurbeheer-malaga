...
const faqs = [
  [
    "¿Cuánto cuesta la gestión de alquiler vacacional en Málaga?",
  ...
  [
    ...
    "Por supuesto. Bloqueamos tus estancias con antelación y adaptamos la estrategia a los periodos en que quieras visitar Málaga.",
  ],
  [
  ...
  [
    "¿En qué zonas de Málaga trabajáis?",
    "Ayudamos a propietarios en Málaga Pueblo, Málaga Este, La Cala de Málaga, Pedregalejo, Huelin, Málaga Golf, Cerrado de Calderón and Miraflores. Cada vivienda y ubicación se valora individualmente.",
  ],
  [
    "¿Necesito licencia turística para alquilar vacacionalmente en Málaga?",
...
function LocalizedHome() {
  ...
  const schema = {
    ...
    description:
      "Gestión integral de propiedades, alquiler vacacional y cuidado de segundas residencias para propietarios en Málaga.",
    parentOrganization: {
      "@type": "Organization",
    ...
    <main lang="es">
      ...
      <header classNombre="site-header">
        <a
          ...
          href="/"
          aria-label="Gestión de propiedades Málaga – Home"
        >
          <img
            src="/vbs-logo-malaga.webp"
            alt="Gestión de propiedades Málaga logo"
            width="54"
            height="54"
          />
        </a>
      ...
      <section classNombre="hero" id="top">
        ...
        <div classNombre="hero-inner">
          ...
          <p>
            Desde Málaga Este and La Cala to Málaga Pueblo, combinamos una gestión inteligente con profesionales locales de confianza. Tienes un único contactoo para reservas, huéspedes, limpieza, mantenimiento y cuidado diario de la vivienda.
          </p>
        ...
        <div classNombre="hero-stats">
          ...
          <span>
            <CheckCircle2 aria-hidden="true" />
            <b>Servicio local</b> in Málaga y alrededores
          </span>
        </div>
      </section>
      ...
      <section
        ...
        aria-label="Viviendas y propiedades en Málaga"
      >
        <figure classNombre="showcase-wide">
          <img
            src="/villa-zwembad-malaga.webp"
            alt="Villa moderna en Málaga con terraza, piscina y vistas al mar"
            width="1536"
            height="1024"
            loading="eager"
          />
        ...
        <figure>
          <img
            src="/villa-zwembad-malaga.webp"
            alt="Vivienda vacacional en la costa de Málaga"
            width="1800"
            height="1118"
            loading="lazy"
          />
        ...
        <figure>
          <img
            ...
            alt="Vivienda vacacional de lujo en Málaga con vistas al mar"
            width="1600"
            height="1200"
            loading="lazy"
          />
      ...
      <section classNombre="regions compact-regions" id="regios">
        <div classNombre="section-head">
          ...
          <p>
            Desdeal apartments and golf townhouses to hillside villas, we work throughout Málaga Pueblo, La Cala de Málaga, Málaga Este, Pedregalejo, Miraflores, Huelin and Málaga Golf.
          </p>
        </div>
        <div classNombre="area-list" aria-label="Zonas atendidas alrededor de Málaga">
          <b>Málaga Pueblo</b>
          <b>Málaga Este</b>
      ...
      <section classNombre="home-team">
        <div classNombre="home-team-copy">
          ...
          <h2>Personal contacto with people who know Málaga.</h2>
          <p>
      ...
      <section classNombre="knowledge compact-knowledge" id="kennisbank">
        <div classNombre="section-head">
          ...
          <p>
            Información clara sobre costes, estrategia de alquiler, normativa y gestión de propiedades en Málaga.
          </p>
        </div>
      ...
      <section classNombre="faq">
        <div>
          ...
          <p>
            Preguntas clave sobre nuestros servicios y tarifas en Málaga.
          </p>
        </div>
        <div>
          {homeFaqs.map(([q, a], i) => (
      ...
      <footer classNombre="site-footer">
        <div classNombre="footer-brand">
          <a classNombre="logo-lockup" href="/" aria-label="Home">
            <img
              src="/vbs-logo-malaga.webp"
              alt="Gestión de propiedades Málaga"
              width={640}
              height={640}
              sizes="54px"
            />
          ...
          <p>
            Gestión de propiedades Málaga forma parte de{" "}
