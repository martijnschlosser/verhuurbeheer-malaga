...
const services = [
  ...
  },
  {
    ...
    slug: "langetermijnverhuur-malaga",
  ...
  },
  {
    ...
    slug: "schoonmaak-onderhoud-malaga",
  ...
  },
  {
    ...
    slug: "renovatie-inrichting-malaga",
...
const faqs = [
  [
    "How much does holiday rental management in Málaga cost?",
  ...
  [
    ...
    "Of course. We block your own stays in advance and align the rental strategy with the periods when you want to visit Málaga.",
  ],
  [
  ...
  [
    "Which areas of Málaga do you cover?",
    "We support owners in Málaga Pueblo, Málaga Este, La Cala de Málaga, Pedregalejo, Huelin, Málaga Golf, Cerrado de Calderón and Miraflores. Every property and location is assessed individually.",
  ],
  [
    "Do I need a rental licence for holiday rentals in Málaga?",
...
function LocalizedHome() {
  ...
  const schema = {
    ...
    description:
      "Full-service property management, holiday rental management and second-home care for owners in Málaga.",
    parentOrganization: {
      "@type": "Organization",
    ...
    areaServed: [
      ...
      { "@type": "Place", name: "Málaga Pueblo" },
      { "@type": "Place", name: "Málaga Este" },
      { "@type": "Place", name: "La Cala de Málaga" },
      { "@type": "Place", name: "Pedregalejo" },
      { "@type": "Place", name: "Huelin" },
      { "@type": "Place", name: "Málaga Golf" },
      { "@type": "Place", name: "Cerrado de Calderón" },
    ...
    url: absoluteUrl("/es/"),
    logo: absoluteUrl("/vbs-logo-malaga.webp"),
    image: absoluteUrl("/terras-zonsondergang-malaga.webp"),
    sameAs: [
    ...
    <main lang="es">
      ...
      <header className="site-header">
        <a
          ...
          href="/"
          aria-label="Property Management Málaga – Home"
        >
          <img
            src="/vbs-logo-malaga.webp"
            alt="Property Management Málaga logo"
            width="54"
            height="54"
          />
        </a>
        <nav>
          ...
          <details className="services-menu">
            ...
            <div>
              <a href="/vakantieverhuur-malaga/">Gestión de alquiler vacacional</a>
              <a href="/midterm-verhuur-malaga/">
                Alquiler de temporada
              </a>
              <a href="/langetermijnverhuur-malaga/">Alquiler de larga duración</a>
              <a href="/vastgoedbeheer-malaga/">Gestión de propiedades</a>
              ...
              <a href="/verhuurlicentie-malaga/">Licencia de alquiler</a>
            </div>
          </details>
        ...
        <details className="mobile-menu">
          ...
          <div>
            ...
            <b>Servicios</b>
            <a href="/vakantieverhuur-malaga/">Gestión de alquiler vacacional</a>
            <a href="/midterm-verhuur-malaga/">Alquiler de temporada</a>
            <a href="/langetermijnverhuur-malaga/">Alquiler de larga duración</a>
            <a href="/vastgoedbeheer-malaga/">Gestión de propiedades</a>
            <a href="/schoonmaak-onderhoud-malaga/">Limpieza y mantenimiento</a>
            <a href="/renovatie-inrichting-malaga/">Reforma y decoración</a>
            <a href="/verhuurlicentie-malaga/">Licencia de alquiler</a>
            <b>Company</b>
            <a href="/werkwijze/">Cómo trabajamos</a>
            <a href="/over-ons/">Quiénes somos</a>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-inner">
          ...
          <p>
            From Málaga Este and La Cala to Málaga Pueblo, we combine smart rental management with trusted local people. You have one clear contact for bookings, guests, cleaning, maintenance and the day-to-day care of your property.
          </p>
        ...
        <div className="hero-stats">
          ...
          <span>
            <CheckCircle2 aria-hidden="true" />
            <b>Local service</b> in Málaga and the surrounding area
          </span>
        </div>
      </section>
      ...
      <section
        ...
        aria-label="Homes and property in Málaga"
      >
        <figure className="showcase-wide">
          <img
            src="/villa-zwembad-malaga.webp"
            alt="Modern villa in Málaga with terrace, pool and sea views"
            width="1536"
            height="1024"
            loading="eager"
          />
        ...
        <figure>
          <img
            src="/villa-zwembad-malaga.webp"
            alt="Holiday home on the Málaga coast"
            width="1800"
            height="1118"
            loading="lazy"
          />
        ...
        <figure>
          <img
            ...
            alt="Luxury holiday home in Málaga with sea views"
            width="1600"
            height="1200"
            loading="lazy"
          />
      ...
      <aside className="license-note">
        ...
        <a href="/verhuurlicentie-malaga/">Read about rental licensing →</a>
      </aside>
      ...
      <section className="rental-band">
        ...
        <div className="rental-options">
          ...
          <a href="/langetermijnverhuur-malaga/">
      ...
      <section className="regions compact-regions" id="regios">
        <div className="section-head">
          ...
          <p>
            From coastal apartments and golf townhouses to hillside villas, we work throughout Málaga Pueblo, La Cala de Málaga, Málaga Este, Pedregalejo, Miraflores, Huelin and Málaga Golf.
          </p>
        </div>
        <div className="area-list" aria-label="Areas covered around Málaga">
          <b>Málaga Pueblo</b>
          <b>Málaga Este</b>
          <b>La Cala de Málaga</b>
          <b>Pedregalejo</b>
          <b>Huelin</b>
          <b>Málaga Golf</b>
          <b>Fuengirola</b>
      ...
      <section className="home-team">
        <div className="home-team-copy">
          ...
          <h2>Personal contact with people who know Málaga.</h2>
          <p>
      ...
      <section className="knowledge compact-knowledge" id="kennisbank">
        <div className="section-head">
          ...
          <p>
            Clear guidance on costs, rental strategy, regulations and property management in Málaga.
          </p>
        </div>
        <div className="knowledge-grid">
          <a href="/kosten-verhuurbeheer-malaga/">
            <small>Costs</small>
      ...
      <section className="faq">
        <div>
          ...
          <p>
            Key questions about our services and fees in Málaga.
          </p>
        </div>
        <div>
          {homeFaqs.map(([q, a], i) => (
      ...
      <section className="contact" id="contact">
        <div>
          ...
          <h2>Recibe una previsión de alquiler para tu vivienda en Málaga</h2>
          <p>
      ...
      <footer className="site-footer">
        <div className="footer-brand">
          <a className="logo-lockup" href="/" aria-label="Home">
            <img
              src="/vbs-logo-malaga.webp"
              alt="Property Management Málaga"
              width={640}
              height={640}
              sizes="54px"
            />
          ...
          <p>
            Property Management Málaga is part of{" "}
...
export const metadata = { robots: { index: false, follow: true }, keywords: ["gestión de propiedades Málaga","gestión de alquiler vacacional Málaga","gestión de Airbnb Málaga","custodia de llaves Málaga","revisión de viviendas Málaga","gestión de segunda residencia Málaga","mantenimiento de viviendas Málaga","administración de propiedades Málaga"], title: "Gestión de Propiedades en Málaga | Alquiler Vacacional y Llaves", description: "Gestión local de propiedades en Málaga: alquiler vacacional, gestión de Airbnb, custodia de llaves, revisiones, limpieza y mantenimiento.", alternates: { canonical: "/es/", languages: { "nl-NL": "/", en: "/en/", es: "/es/", "x-default": "/" } }, openGraph: { locale: "es_ES", url: "/es/", type: "website" as const } };
