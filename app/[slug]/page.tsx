...
const seoH1BySlug: Record<string, string> = {
  "vakantieverhuur-malaga": "Vakantieverhuur in Málaga vanaf 18%",
  "midterm-verhuur-malaga": "Midterm verhuur in Málaga",
  "langetermijnverhuur-malaga": "Langetermijnverhuur in Málaga",
  "vastgoedbeheer-malaga": "Vastgoedbeheer in Málaga",
  "schoonmaak-onderhoud-malaga": "Schoonmaak en onderhoud in Málaga",
  "renovatie-inrichting-malaga": "Renovatie en inrichting in Málaga",
  "kosten-verhuurbeheer-malaga": "Wat kost verhuurbeheer in Málaga?",
  "dynamische-prijzen-vakantiewoning":
    "Dynamische prijzen voor een vakantiewoning in Málaga",
  "zelf-verhuren-of-verhuurbeheer":
    "Zelf verhuren of verhuurbeheer in Málaga?",
  "verhuurlicentie-malaga":
    "Verhuurlicentie in Málaga aanvragen en controleren",
  "over-ons": "Over Verhuurbeheer Málaga",
  werkwijze: "Werkwijze voor verhuurbeheer in Málaga",
  contact: "Contact met Verhuurbeheer Málaga",
  "woning-aanmelden": "Woning aanmelden voor verhuurbeheer in Málaga",
  blog: "Blogs over verhuurbeheer in Málaga",
};
...
const team = [
  {
    ...
    role: "Relatiemanager",
    languages: "NL · EN · ES",
    image: "/martijn-verhuurbeheer-malaga.webp",
  ...
  },
  {
    ...
    role: "Manager Bouw",
    languages: "NL · EN",
    image: "/geert-vastgoedbeheer-malaga.webp",
...
const relatedBySlug: Record<string, string[]> = {
  "vakantieverhuur-malaga": [
    "verhuurlicentie-malaga",
    "kosten-verhuurbeheer-malaga",
    "dynamische-prijzen-vakantiewoning",
  ],
  "vastgoedbeheer-malaga": [
    "schoonmaak-onderhoud-malaga",
    "vakantieverhuur-malaga",
    "zelf-verhuren-of-verhuurbeheer",
  ],
  "midterm-verhuur-malaga": [
    "langetermijnverhuur-malaga",
    "vastgoedbeheer-malaga",
    "kosten-verhuurbeheer-malaga",
  ],
  "langetermijnverhuur-malaga": [
...
Object.assign(relatedBySlug, {
  "comunidad-afspraken-appartement-malaga": ["vastgoedbeheer-malaga","appartement-verhuren-malaga","sleutelbeheer-malaga","stadsappartement-beheren-op-afstand-malaga","kosten-verhuurbeheer-malaga"],
  "vastgoedbeheer-malaga": ["comunidad-afspraken-appartement-malaga", ...(relatedBySlug["vastgoedbeheer-malaga"] ?? []).filter((slug) => slug !== "comunidad-afspraken-appartement-malaga")].slice(0, 6),
  "appartement-verhuren-malaga": ["comunidad-afspraken-appartement-malaga", ...(relatedBySlug["appartement-verhuren-malaga"] ?? []).filter((slug) => slug !== "comunidad-afspraken-appartement-malaga")].slice(0, 6),
  "sleutelbeheer-malaga": ["comunidad-afspraken-appartement-malaga", ...(relatedBySlug["sleutelbeheer-malaga"] ?? []).filter((slug) => slug !== "comunidad-afspraken-appartement-malaga")].slice(0, 6),
});

const contentVisualBySlug: Record<string, { src: string; alt: string }> = {
  "vakantieverhuur-malaga": {
    src: "/luxe-woning-malaga-zeezicht.webp",
    alt: "Luxe vakantiewoning in Málaga met lichte woonkamer en uitzicht op zee",
  },
  "midterm-verhuur-malaga": {
    src: "/luxe-interieur-malaga.webp",
    alt: "Licht ingericht appartement voor seizoens- en midtermverhuur in Málaga",
  },
  "langetermijnverhuur-malaga": {
    src: "/luxe-interieur-malaga.webp",
    alt: "Verzorgd interieur van een woning voor langetermijnverhuur in Málaga",
  },
  "vastgoedbeheer-malaga": {
    src: "/villa-zwembad-malaga.webp",
    alt: "Zwembad en mediterrane tuin bij een professioneel beheerde villa in Málaga",
  },
  "schoonmaak-onderhoud-malaga": {
    src: "/luxe-interieur-malaga.webp",
    alt: "Schoon en verzorgd interieur van een beheerde woning in Málaga",
  },
  "renovatie-inrichting-malaga": {
    src: "/terras-zonsondergang-malaga.webp",
    alt: "Luxe terras van een ingerichte woning in Málaga bij zonsondergang",
  },
  werkwijze: {
    src: "/zonnig-terras-zeezicht-malaga.webp",
    alt: "Zonnig terras van een beheerde vakantiewoning in Málaga met zeezicht",
  },
};
...
> = {
  "kosten-verhuurbeheer-malaga": {
    src: "/vastgoed-aan-zee-malaga.webp",
    alt: "Woningen aan zee bij Málaga als illustratie bij de kosten van verhuurbeheer",
    category: "Kosten & tarieven",
    readTime: "4 min",
  },
  "dynamische-prijzen-vakantiewoning": {
    src: "/luxe-woning-malaga-zeezicht.webp",
    alt: "Luxe vakantiewoning met zeezicht in Málaga voor een blog over dynamische prijzen",
    category: "Opbrengst",
    readTime: "4 min",
  },
  "zelf-verhuren-of-verhuurbeheer": {
  ...
  "verhuurlicentie-malaga": {
    src: "/malaga-hero.webp",
    alt: "Uitzicht over Málaga bij informatie over de verhuurlicentie",
...
export default async function ContentRoute({
  ...
  const organization = {
    ...
    logo: {
      "@type": "ImageObject",
      url: absoluteUrl("/vbs-logo-malaga.webp"),
    },
  };
  const pageSchema =
    page.type === "gids"
  ...
  const trustItems =
    page.slug === "langetermijnverhuur-malaga"
      ? [
          <>
      ...
      : page.slug === "vastgoedbeheer-malaga"
        ? [
            <>
    ...
    <main className="content-page" id="top">
      ...
      <header className="content-header">
        <a
          className="brand"
          href="/"
          aria-label="Verhuurbeheer Málaga – naar Home"
        >
        ...
        <nav>
          ...
          <details className="services-menu">
            ...
            <div>
              <a href="/vakantieverhuur-malaga/">Vakantieverhuur</a>
              <a href="/midterm-verhuur-malaga/">
                Seizoens- en midtermverhuur
              </a>
              <a href="/langetermijnverhuur-malaga/">Langetermijnverhuur</a>
              <a href="/vastgoedbeheer-malaga/">Vastgoedbeheer</a>
              <a href="/schoonmaak-onderhoud-malaga/">
                Schoonmaak & onderhoud
              </a>
              <a href="/renovatie-inrichting-malaga/">
                Renovatie & inrichting
              </a>
              <a href="/verhuurlicentie-malaga/">Verhuurlicentie</a>
            </div>
          </details>
        ...
        <details className="mobile-menu">
          ...
          <div>
            ...
            <b>Diensten</b>
            <a href="/vakantieverhuur-malaga/">Vakantieverhuur</a>
            <a href="/midterm-verhuur-malaga/">Seizoens- en midtermverhuur</a>
            <a href="/langetermijnverhuur-malaga/">Langetermijnverhuur</a>
            <a href="/vastgoedbeheer-malaga/">Vastgoedbeheer</a>
            <a href="/schoonmaak-onderhoud-malaga/">Schoonmaak & onderhoud</a>
            <a href="/renovatie-inrichting-malaga/">Renovatie & inrichting</a>
            <a href="/verhuurlicentie-malaga/">Verhuurlicentie</a>
            <b>Bedrijf</b>
            <a href="/werkwijze/">Werkwijze</a>
            <a href="/over-ons/">Over ons</a>
      ...
      <section className="content-hero">
        ...
        <aside>
          ...
          <strong>{page.price ?? "Málaga · Costa del Sol"}</strong>
          <p>
        ...
        <section className="signup-experience" id="woningformulier">
          <div className="signup-story">
            ...
            <div className="signup-photo">
              ...
              <span>Málaga · Costa del Sol</span>
            </div>
          ...
          <FormSubmit className="signup-form" action={leadFormAction} thankYouPath={siteConfig.template.thankYouPath}>
            ...
            <label>Locatie woning<input name="locatie" placeholder="Bijv. Málaga Este, El Limonar of Málaga Centro" required /></label>
        ...
        <section className="contact contact-page-form" id="woningformulier">
          ...
          >
            ...
            <label>
              ...
              <input
                name="locatie"
                placeholder="Bijv. Málaga Este of Málaga Centro"
                required
              />
            </label>
            <label>
      ...
      {page.slug === "blog" && featuredBlog ? (
        <section
          ...
          aria-label="Alle blogs over verhuurbeheer in Málaga"
        >
      ...
      {page.slug === "verhuurlicentie-malaga" && (
      ...
      {page.slug !== "blog" && page.slug !== "contact" && page.slug !== "woning-aanmelden" && (
        <section className="related">
          ...
          <h2>Meer voor eigenaren in Málaga</h2>
          <div>
            {related.map((r) => (
        ...
        <section className="blog-lead">
          ...
          >
            ...
            <label>
              ...
              <input
                name="locatie"
                placeholder="Bijv. Málaga, Málaga Este of Rincón de la Victoria"
              />
            </label>
            <label className="wide">
              Je vraag
      ...
      <footer className="site-footer">
        <div className="footer-brand">
          <a className="brand" href="/" aria-label="Naar Home">
            <span className="brand-mark">●</span>
            <span>
              Verhuurbeheer <b>Málaga</b>
            </span>
          </a>
          <p>
            Verhuurbeheer Málaga is onderdeel van{" "}
        ...
        <div>
          ...
          <a href="/vastgoedbeheer-malaga/">Vastgoedbeheer</a>
          <a href="/verhuurlicentie-malaga/">Verhuurlicentie</a>
          <a href="/nederlandse-verhuurmakelaar-malaga/">Nederlandse verhuurmakelaar</a>
          <a href="/sleutelbeheer-malaga/">Sleutelbeheer</a>
          <a href="/appartement-verhuren-malaga/">Appartement verhuren</a>
          <a href="/villa-verhuren-malaga/">Villa verhuren</a>
          <a href="/airbnb-beheer-malaga/">Airbnb & Booking beheer</a>
          <a href="/tweede-woning-beheer-malaga/">Tweede woning beheer</a>
        </div>
        <div>
          <b>Meer</b>
          <a href="/werkwijze/">Werkwijze</a>
        ...
        <div>
          ...
          <small>© 2026 · Málaga · Costa del Sol</small>
        </div>
      </footer>
      <a
